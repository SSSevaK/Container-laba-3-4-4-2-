...
bool prov_row(int&);
bool prov_col(int&);
bool Fill_mas_rand(std::vector<std::vector<int>>&, int, int);
...
void anothersort(std::vector<std::vector<int>>&, int, int);
int sum_elem_with_zero(std::vector<std::vector<int>>&, int, int);
int main()
{
    try
    {
...
bool Fill_mas_rand(std::vector<std::vector<int>>&  mas, int row, int col)
{
...
int sum_elem_with_zero(std::vector<std::vector<int>>& arr, int row, int col)
{
    int sum = 0;
    for (int i = 0; i < row; i++)
    {
...
void anothersort(std::vector<std::vector<int>>& arr1, int row, int col)
{
